...
docker run --name gitrunner -it --privileged=true -v /Users/raja/.docker/run/docker.sock:/var/run/docker.sock -e GH_TOKEN='' -e GH_OWNER='rajadev2019' -e GH_REPOSITORY='docker-github-runner-linux' -d docker-github-runner-linux
